...
export default function handler(request, res) {
  ...
  const data = {
    ...
    images: [
      {
        id: "inv-1",
        title: "Almost hurt Cecil",
        description: "This was like the fourth time I almost hurt Cecil.",
        alt: "Invincible mad at Sea Salt",
      ...
      },
      {
        ...
        alt: "Invincible's about to ruin somones day",
      ...
      },
      {
        ...
        alt: "Mark smiling in his Invincible costume",
        image: "https://i.pinimg.com/736x/82/f1/63/82f163dcb5de22326d3c89a9b1b4b772.jpg",
      ...
      },
      {
        ...
        alt: "Invincible looking handsome and wealthy",
      ...
      },
      {
        ...
        alt: "Conquest grabbing Omni-Man before Invincible steps in",
      ...
      },
      {
        ...
        alt: "Omni man beating mark to a pulp",
      ...
      {
        id: "inv-14",
        title: "Tearing Up the flaxans",
        description: "My dad tearing up the flaxans.",
        alt: "Omni-Man unleashing his full power on the Flaxans",
